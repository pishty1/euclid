...
var vec__13513 = axis;
var a_x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13513,(0),null);
var a_y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13513,(1),null);
var a_z = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13513,(2),null);
var vec__13516 = v;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13516,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13516,(1),null);
var z = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13516,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__13519,p__13520){
var vec__13521 = p__13519;
var u1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13521,(0),null);
var u2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13521,(1),null);
var u3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13521,(2),null);
var vec__13524 = p__13520;
var v1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13524,(0),null);
var v2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13524,(1),null);
var v3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13524,(2),null);
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__13527_SHARP_){
return (p1__13527_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
var rotate = (function (p1__13528_SHARP_){
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle(p1__13528_SHARP_,axis,angle);
});
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(state,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$navigation_DASH_3d], null),(function (p1__13529_SHARP_){
return quil.middlewares.navigation_3d.rotate_ud(quil.middlewares.navigation_3d.rotate_lr(p1__13529_SHARP_,angle_lr),angle_ud);
}));
}
});
...
var map__13531 = cljs.core.cst$kw$navigation_DASH_3d.cljs$core$IFn$_invoke$arity$1(state);
var map__13531__$1 = (((((!((map__13531 == null))))?(((((map__13531.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__13531.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__13531):map__13531);
var up = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13531__$1,cljs.core.cst$kw$up);
var straight = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13531__$1,cljs.core.cst$kw$straight);
var temp__5802__auto__ = (function (){var pred__13533 = cljs.core._EQ_;
var expr__13534 = cljs.core.cst$kw$key.cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_((function (){var G__13536 = cljs.core.cst$kw$w;
var G__13537 = expr__13534;
return (pred__13533.cljs$core$IFn$_invoke$arity$2 ? pred__13533.cljs$core$IFn$_invoke$arity$2(G__13536,G__13537) : pred__13533.call(null,G__13536,G__13537));
})())){
return straight;
} else {
if(cljs.core.truth_((function (){var G__13538 = cljs.core.cst$kw$s;
var G__13539 = expr__13534;
return (pred__13533.cljs$core$IFn$_invoke$arity$2 ? pred__13533.cljs$core$IFn$_invoke$arity$2(G__13538,G__13539) : pred__13533.call(null,G__13538,G__13539));
})())){
return quil.middlewares.navigation_3d.v_opposite(straight);
} else {
if(cljs.core.truth_((pred__13533.cljs$core$IFn$_invoke$arity$2 ? pred__13533.cljs$core$IFn$_invoke$arity$2(quil.middlewares.navigation_3d.space,expr__13534) : pred__13533.call(null,quil.middlewares.navigation_3d.space,expr__13534)))){
return quil.middlewares.navigation_3d.v_opposite(up);
} else {
if(cljs.core.truth_((function (){var G__13540 = cljs.core.cst$kw$z;
var G__13541 = expr__13534;
return (pred__13533.cljs$core$IFn$_invoke$arity$2 ? pred__13533.cljs$core$IFn$_invoke$arity$2(G__13540,G__13541) : pred__13533.call(null,G__13540,G__13541));
})())){
return up;
} else {
if(cljs.core.truth_((function (){var G__13542 = cljs.core.cst$kw$d;
var G__13543 = expr__13534;
return (pred__13533.cljs$core$IFn$_invoke$arity$2 ? pred__13533.cljs$core$IFn$_invoke$arity$2(G__13542,G__13543) : pred__13533.call(null,G__13542,G__13543));
})())){
return quil.middlewares.navigation_3d.cross_product(straight,up);
} else {
if(cljs.core.truth_((function (){var G__13544 = cljs.core.cst$kw$a;
var G__13545 = expr__13534;
return (pred__13533.cljs$core$IFn$_invoke$arity$2 ? pred__13533.cljs$core$IFn$_invoke$arity$2(G__13544,G__13545) : pred__13533.call(null,G__13544,G__13545));
})())){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$navigation_DASH_3d,cljs.core.cst$kw$position], null),(function (p1__13530_SHARP_){
return quil.middlewares.navigation_3d.v_plus(p1__13530_SHARP_,quil.middlewares.navigation_3d.v_mult(dir,step_size));
}));
} else {
return state;
}
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3((user_setup.cljs$core$IFn$_invoke$arity$0 ? user_setup.cljs$core$IFn$_invoke$arity$0() : user_setup.call(null)),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$navigation_DASH_3d], null),(function (p1__13546_SHARP_){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([initial_state,p1__13546_SHARP_], 0));
}));
});
/**
...
var rotate_on_fn = (function (){var G__13547 = options;
var G__13548 = (function (state,_){
return state;
});
return (rotate_on.cljs$core$IFn$_invoke$arity$2 ? rotate_on.cljs$core$IFn$_invoke$arity$2(G__13547,G__13548) : rotate_on.call(null,G__13547,G__13548));
})();
...
var map__13549_13564 = cljs.core.cst$kw$navigation_DASH_3d.cljs$core$IFn$_invoke$arity$1(state);
var map__13549_13565__$1 = (((((!((map__13549_13564 == null))))?(((((map__13549_13564.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__13549_13564.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__13549_13564):map__13549_13564);
var vec__13550_13566 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13549_13565__$1,cljs.core.cst$kw$straight);
var c_x_13567 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13550_13566,(0),null);
var c_y_13568 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13550_13566,(1),null);
var c_z_13569 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13550_13566,(2),null);
var vec__13553_13570 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13549_13565__$1,cljs.core.cst$kw$up);
var u_x_13571 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13553_13570,(0),null);
var u_y_13572 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13553_13570,(1),null);
var u_z_13573 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13553_13570,(2),null);
var vec__13556_13574 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13549_13565__$1,cljs.core.cst$kw$position);
var p_x_13575 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13556_13574,(0),null);
var p_y_13576 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13556_13574,(1),null);
var p_z_13577 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13556_13574,(2),null);
quil.core.camera.cljs$core$IFn$_invoke$arity$9(p_x_13575,p_y_13576,p_z_13577,(p_x_13575 + c_x_13567),(p_y_13576 + c_y_13568),(p_z_13577 + c_z_13569),u_x_13571,u_y_13572,u_z_13573);
...
var G__13560 = quil.middlewares.navigation_3d.move(state,event,step_size);
var G__13561 = event;
return (key_pressed.cljs$core$IFn$_invoke$arity$2 ? key_pressed.cljs$core$IFn$_invoke$arity$2(G__13560,G__13561) : key_pressed.call(null,G__13560,G__13561));
}),rotate_on,(function (state,event){
var G__13562 = quil.middlewares.navigation_3d.rotate(state,event,pixels_in_360);
var G__13563 = event;
return (rotate_on_fn.cljs$core$IFn$_invoke$arity$2 ? rotate_on_fn.cljs$core$IFn$_invoke$arity$2(G__13562,G__13563) : rotate_on_fn.call(null,G__13562,G__13563));
})], 0));
});
